...
def evaluate_board(board):
    ...
    for piece in board.piece_map().values():
        ...
        if piece.color == chess.WHITE:
            ...
            material_balance -= value
    final_val: list = [material_balance]
...
def get_position_score(board):
    ...
    good_rook_positions_white = [chess.D1, chess.E1, chess.F1, chess.A4, chess.H4]  # chess.C1,
    ...
    good_rook_positions_black = [chess.D8, chess.E8, chess.F8, chess.C8, chess.A5, chess.H5]
